...
export function getVirtualNetworkAssetsAttachedToTag(tagName?: string): Array<string> {var freshService = nl.itq.freshservice
var ciTypeName = "Virtual Network";
...
return relationshipObjects.filter(function(asset) {
	...
	return asset.config_item.name + " [" + asset.config_item.levelfield_values["iprange_" + ciTypeId] + "]";
});
