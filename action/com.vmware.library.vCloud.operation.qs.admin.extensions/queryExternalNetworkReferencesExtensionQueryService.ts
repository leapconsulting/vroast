...
namespace com.vmware.library.vCloud.operation.qs.admin.extensions {
export function queryExternalNetworkReferencesExtensionQueryService(host?: vCloud.Host, expressionParams?: Array<any>, filterType?: vCloud.FilterType): Array<any> {// WARNING: Auto generated code. Please, do not edit this code.
...
var srv = host.toAdminObject().toAdminExtensionObject().getExtensionQueryService();
...
var referenceRSet = srv.queryExternalNetworkReferences(params);
